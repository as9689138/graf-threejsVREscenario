...
export function createBoxingRing(scene, manager, ringConfig) {
    ...
    function createBleachers() {
        ...
        const aficionTexture = textureLoader.load('assets/textures/aficion3.png');
    ...
    function createFlashes() {
        ...
        const scales = new Float32Array(flashCount);
        const phases = new Float32Array(flashCount);
        ...
        for (let i = 0; i < flashCount; i++) {
            ...
            const altoGradaEnEsePunto = (profundidadAleatoria * (40 / 80)) + 80;
            ...
            scales[i] = Math.random() * 12 + 10;;
            phases[i] = Math.random() * Math.PI * 2;
        }

        flashGeometry.setAttribute('position',new THREE.BufferAttribute(positions, 3));
        flashGeometry.setAttribute('scale', new THREE.BufferAttribute(scales, 1));
        flashGeometry.setAttribute("phase", new THREE.BufferAttribute(phases, 1));
        ...
        const flashMaterial = new THREE.ShaderMaterial({
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    // FLICKER
                    float flicker = sin(time * 10.0 + vPhase) * 0.5 + 0.5;
